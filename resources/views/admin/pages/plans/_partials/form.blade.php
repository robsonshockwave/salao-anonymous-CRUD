...
<div class="form-group">
    <label>Nome:</label>
    <input type="text" name="name" class="form-control" placeholder="Nome: " value="{{ $plan->name ?? old('name') }}"> <!--esse old('') vai fazer voltar com os campos preenchidos caso rejeitado-->
</div>
<div class="form-group">
    <label>Preço:</label>
